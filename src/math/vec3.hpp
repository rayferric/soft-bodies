...
#pragma region Operators
	...
	friend vec3<std::common_type_t<L, R>> operator*(L lhs, const vec3<R> &rhs);
...
class hash<soft_bodies::math::vec3<T>> {
public:
	std::size_t operator()(soft_bodies::math::vec3<T> vec) const;
};
