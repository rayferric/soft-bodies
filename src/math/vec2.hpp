...
#pragma region Operators
	...
	friend vec2<std::common_type_t<L, R>> operator*(L lhs, const vec2<R> &rhs);
...
class hash<soft_bodies::math::vec2<T>> {
public:
	std::size_t operator()(soft_bodies::math::vec2<T> vec) const;
};
